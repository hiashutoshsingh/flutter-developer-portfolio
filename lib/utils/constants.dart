...
class Constants {
  ...
  static final String mediumUrl = 'https://medium.com/@hiashutoshsingh';
  static final String stackoverflowUrl = 'https://stackoverflow.com/users/6875249/hiashutoshsingh';
